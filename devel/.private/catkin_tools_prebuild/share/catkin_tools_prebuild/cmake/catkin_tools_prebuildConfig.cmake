...
set(catkin_tools_prebuild_SOURCE_PREFIX /home/project26-group3/connect-four/build/catkin_tools_prebuild)
set(catkin_tools_prebuild_DEVEL_PREFIX /home/project26-group3/connect-four/devel/.private/catkin_tools_prebuild)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'catkin_tools_prebuild' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/project26-group3/connect-four/build/catkin_tools_prebuild/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/project26-group3/connect-four/devel/.private/catkin_tools_prebuild/lib;/home/project26-group3/ros/devel/lib;/opt/ros/cu/lib;/opt/ros/one/lib)
