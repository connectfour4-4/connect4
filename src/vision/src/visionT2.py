...
class VisionNode:
    ...
    def detect_board_and_overlay(self, frame, depth=None):
        ...
        # changed to make the cell center the destination points

        half_cell_w = self.warp_cell_px / 2.0
        half_cell_h = self.warp_cell_px / 2.0

        dst_quad = np.array([
            [half_cell_w,           half_cell_h          ], 
            [warp_w - half_cell_w,  half_cell_h          ],
            [warp_w - half_cell_w,  warp_h - half_cell_h ], 
            [half_cell_w,           warp_h - half_cell_h ],  
        ], dtype=np.float32)
